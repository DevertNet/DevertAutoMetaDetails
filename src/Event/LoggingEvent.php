...
namespace Devert\AutoMetaDetails\Event;
...
class LoggingEvent extends Event implements BusinessEventInterface, LogAwareBusinessEventInterface
{
    public const NAME = 'devert_autometadetails.log';
